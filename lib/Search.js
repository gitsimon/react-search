...
var Search = function (_Component) {
  ...
  _createClass(Search, null, [{
    ...
    get: function get() {
      return {
        ...
        removeMiddleware: _react2.default.PropTypes.func,
        addMiddleware: _react2.default.PropTypes.func
      };
    }
  }]);
  ...
  _createClass(Search, [{
    ...
    value: function addSelected(selected) {
      var _this4 = this;
      this.props.addMiddleware && this.props.addMiddleware(selected.id, selected.value);
    ...
    value: function handleRemove(e) {
      e.preventDefault();
      e.stopPropagation();
      this.props.removeMiddleware && this.props.removeMiddleware(e.target.dataset.id);
    ...
    value: function handleItemClick(e) {
      //this.focusInput();  Prevent result menu when click on items
    }
  }, {
    key: 'handleSelect',
